...
function getArtistByIndex(array, index) {
    /* code here */
    return `The artist at ${index} is ${name}`
  }
...
for(let i = 0; i < array.length; i++){
  console.log
  if (array[i].years.split("-").filter(year => year > 1900).length > 0){
    over.push(array[i].name)
  }
}
return over
}
...
console.log(addArtist(artists, '21', 'dalton', '1999', 'rap', 'merica', 'cool guy'))
